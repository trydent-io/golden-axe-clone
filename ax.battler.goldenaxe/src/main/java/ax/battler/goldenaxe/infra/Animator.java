...
public class Animator {
  ...
  private final String shadowActorId;
  private final String shadowAnimationId;
  ...
  public void update(Map<String, Actor> actors, double lerp) {
    ...
    for (String actorId : keyframes.keySet()) {
      ...
      if (actor == null) {
        ...
        //        + name + " couldn't find ax.battler.goldenaxe.actor '" + actorId + "' !");
        continue;
      }
      ...
      if (ceilIndex != null) {
        ...
        // ax.battler.goldenaxe.actor animator finished TODO
      }
    }
  ...
  public static class AnimatorFrame {
    ...
    public static void lerp(double frameIndex, AnimatorFrame previousFrame
      ...
      double p = (frameIndex - previousFrame.frameIndex)
