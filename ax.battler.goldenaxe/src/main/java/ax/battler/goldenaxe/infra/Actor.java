...
import ax.battler.goldenaxe.actor.Dust;
import ax.battler.goldenaxe.actor.Enemy;
import ax.battler.goldenaxe.actor.Item;
import ax.battler.goldenaxe.actor.Player.PlayerCharacter;
import ax.battler.goldenaxe.actor.Projectile;
import ax.battler.goldenaxe.actor.Thief;
import ax.battler.goldenaxe.actor.magic.FireA;
import ax.battler.goldenaxe.actor.magic.FireB;
import ax.battler.goldenaxe.actor.magic.FireC;
import ax.battler.goldenaxe.actor.magic.FireD;
import ax.battler.goldenaxe.actor.magic.FireE;
import ax.battler.goldenaxe.actor.magic.FireF;
import ax.battler.goldenaxe.actor.magic.LightningA;
import ax.battler.goldenaxe.actor.magic.LightningB;
import ax.battler.goldenaxe.actor.magic.LightningC;
import ax.battler.goldenaxe.actor.magic.VolcanoABC;
import ax.battler.goldenaxe.actor.magic.VolcanoD;
import ax.battler.goldenaxe.infra.Animation.Frame;
import ax.battler.goldenaxe.infra.Animation.FramePoint;
import ax.battler.goldenaxe.infra.Animator.AnimatorFrame;
...
import static ax.battler.goldenaxe.actor.magic.VolcanoABC.Type.VOLCANO_A;
import static ax.battler.goldenaxe.actor.magic.VolcanoABC.Type.VOLCANO_B;
import static ax.battler.goldenaxe.actor.magic.VolcanoABC.Type.VOLCANO_C;
import static ax.battler.goldenaxe.infra.Actor.Control.IA;
import static ax.battler.goldenaxe.infra.Actor.Control.PLAYER_1;
import static ax.battler.goldenaxe.infra.Actor.Control.PLAYER_2;
import static ax.battler.goldenaxe.infra.Collider.Reaction.KNOCK_DOWN;
import static ax.battler.goldenaxe.infra.Collider.Reaction.STUNNED_1;
import static ax.battler.goldenaxe.infra.Collider.Reaction.STUNNED_2;
import static ax.battler.goldenaxe.infra.Direction.LEFT;
import static ax.battler.goldenaxe.infra.Direction.RIGHT;
import static ax.battler.goldenaxe.infra.Settings.CREDITS;
import static ax.battler.goldenaxe.infra.Settings.GRAVITY;
import static ax.battler.goldenaxe.infra.Settings.KEY_PLAYER_1_ATTACK;
import static ax.battler.goldenaxe.infra.Settings.KEY_PLAYER_1_DOWN;
import static ax.battler.goldenaxe.infra.Settings.KEY_PLAYER_1_JUMP;
import static ax.battler.goldenaxe.infra.Settings.KEY_PLAYER_1_LEFT;
import static ax.battler.goldenaxe.infra.Settings.KEY_PLAYER_1_MAGIC;
import static ax.battler.goldenaxe.infra.Settings.KEY_PLAYER_1_RIGHT;
import static ax.battler.goldenaxe.infra.Settings.KEY_PLAYER_1_UP;
import static ax.battler.goldenaxe.infra.Settings.KEY_PLAYER_2_ATTACK;
import static ax.battler.goldenaxe.infra.Settings.KEY_PLAYER_2_DOWN;
import static ax.battler.goldenaxe.infra.Settings.KEY_PLAYER_2_JUMP;
import static ax.battler.goldenaxe.infra.Settings.KEY_PLAYER_2_LEFT;
import static ax.battler.goldenaxe.infra.Settings.KEY_PLAYER_2_MAGIC;
import static ax.battler.goldenaxe.infra.Settings.KEY_PLAYER_2_RIGHT;
import static ax.battler.goldenaxe.infra.Settings.KEY_PLAYER_2_UP;
...
import static ax.battler.goldenaxe.infra.Settings.LIVES;
import static ax.battler.goldenaxe.infra.Settings.MAX_ENERGY;
import static ax.battler.goldenaxe.infra.TextRenderer.DEFAULT_FONT_COLOR;
import static ax.battler.goldenaxe.scene.Stage.MAGIC_LAYER;
...
public class Actor extends Entity implements Comparable<Actor> {
    ...
    switch (reaction) {
      ...
      case GRAB_AND_THROW:
        if (stateManager.isStateAvailable("grab_and_throw")
          ...
          wz += 0.0001; // just to ensure this ax.battler.goldenaxe.actor will be in front
  ...
  public int compareTo(Actor o) {
    ...
    // updated and drawn before mouting ax.battler.goldenaxe.actor
    double az = 0.0;
    if (mountedActor != null) {
      az += 0.000001;
    }
  ...
  public enum Control {
    NONE(0), PLAYER_1(1), PLAYER_2(2), IA(3);
  ...
  protected class Mounting extends ActorState {
    ...
    public void onEnter() {
      ...
      wz = mountedActor.getWz() + 0.000001; // ensure this ax.battler.goldenaxe.actor in front
    }
  ...
  protected class Mounted extends ActorState {
    ...
    public void fixedUpdate() {
      ...
      if (firstPoint != null) {
        ...
        wz = mountedActor.getWz() + 0.000001; // this ax.battler.goldenaxe.actor in front
  ...
  protected class GoldenAxe extends ActorState {
    ...
    public void fixedUpdate() {
      ...
      if (!finished && deathAdder != null && started) {
        ...
        wz = deathAdder.getWz() + 0.000001; //ensure this ax.battler.goldenaxe.actor in front
  ...
  protected class WalkTo extends ActorState {
    ...
    @Override
    public void fixedUpdate() {
      // wait until this ax.battler.goldenaxe.actor touches the ground
      if (!isOnFloor()) {
        updateMovement();
        return;
      }
